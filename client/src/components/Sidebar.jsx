    ...
    >
      <div className="pb-5">
        <div className="flex justify-between items-center">
          <img src={assets.chat_big} alt="logo" className="max-w-10" />
          <span className="font-bold text-orange-300">MeChat</span>
          <div className="relative py-2 group">
            ...
            />
            <div className="absolute top-full right-0 z-20 w-32 p-2 rounded-md bg-[#282142] border border-gray-600 hidden group-hover:block">
              <p
                onClick={() => navigate("/profile")}
                className="cursor-pointer text-sm hover:bg-gray-700 p-1 rounded"
              >
                Edit Profile
              </p>
              <hr className="my-2 border-t border-gray-500" />
              <p  onClick={() => logout()}className="cursor-pointer text-sm hover:bg-gray-700 p-1 rounded">
                Logout
              </p>
            </div>
          </div>
