  ...
  return (
    <div className='min-h-screen bg-cover bg-center flex items-center justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
      ...
      <div className='flex flex-col items-center'>
        <img src={assets.chat_big} alt="" className='w-52 sm:w-50 md:w-68' />
        <h1 className="text-white text-3xl font-bold mt-4">MeChat</h1>
      </div>
      ...
      <form onSubmit={onSubmitHandler} className='border-2 bg-white/8 text-white border-gray-500 p-6 flex flex-col gap-6 rounded-lg shadow-lg'>
        ...
        <button type='submit' className='py-3 bg-gradient-to-r mask-b-from-purple-400 mask-b-to-violet-600 text-white rounded-md cursor-pointer'>
          ...
          <div className='flex flex-col gap-2'>
            {currState === "Sign up" ? (
              ...
              <p className='text-sm text-gray-600'>Create an account <span onClick={() => setCurrState("Sign up")} className='font-medium text-violet-500 cursor-pointer'>Clice here</span></p>
            )}
          </div>
      </form>
    </div>
